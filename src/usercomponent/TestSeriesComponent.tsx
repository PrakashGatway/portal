      ...
      <div className="bg-gradient-to-b from-[#CFCFCF] via-[#ECECEC] to-black dark:bg-gray-800 p-[1px] rounded-[22px] relative">
        ...
        >
          ...
          <div className="p-2">
            ...
            {/* Button */}
            {series?.isPurchased === false &&
              series?.pricing.isFree === false && (
                <div className="flex justify-center">
                  <button
                    onClick={() => {
                      series?.pricing?.isFree
                        ? navigate(`/checkout/${series?.slug}`, {
                    ...
                    className="mt-5 py-2  w-1/2 text-base   rounded-xl border border-[#ff5b2e] text-[#ff5b2e] font-medium transition-all duration-300 hover:bg-[#ff5b2e] hover:text-white"
                  >
                    {"Buy Test"}
                  </button>
                </div>
  ...
  const faqs = [
    {
      ...
      answer:
        "All the classes will be available on the app/web version app linkjonty",
    },
    {
              ...
              <>
                <div>
                  <p className="text-gray-800 mb-4">
                    This comprehensive GRE test series is designed to give you
                    the most authentic exam experience possible. Each test
                    mirrors the actual GRE in format, timing, and difficulty
                    level.
                  </p>
                  <p className="text-gray-700">
                    With detailed performance analytics and personalized
                    feedback, you'll be able to identify your strengths and
                    weaknesses, track your progress, and improve your score
                    effectively.
                  </p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-[#fff7dd] p-6 rounded-xl">
                  ...
                  <div className="bg-[#fdf0ec] p-6 rounded-xl">
        ...
        return (
          ...
          >
            ...
            {testSeries?.tests?.map((testItem, index) => {
              ...
              return (
                <div
                  className={`p-[0.8px] rounded-3xl bg-gradient-to-b from-white via-[#2B2B2B] to-black  `}
                >
                  <div
                    className={`w-full rounded-3xl bg-gradient-to-br ${theme.cardBg} overflow-hidden transition-all hover:shadow-sm relative`}
                  >
                    {/* Badge */}
                    <div className="">
                      <span className="inline-flex items-center rounded-full bg-[#ff7046] px-3 ml-1 mt-1  py-1 text-sm text-white font-semibold text-orange-500 uppercase">
          ...
          Held on Jan 07, 2026 at 09:00 AM
                      ...
                      {/* Right */}
                      <div className="flex flex-row md:flex-col items-center justify-center gap-3 md:min-w-[110px] mr-12">
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <ChevronDown
                      className={`h-4 w-4 text-[#FF7046] transition-transform ${
                        isOpen ? "rotate-180" : ""
                      }`}
                    />
                  </button>
