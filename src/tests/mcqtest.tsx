          ...
          <div className="px-4 pt-3 pb-0">
            ...
            <div className="mt-3 grid grid-cols-2 gap-y-2.5 text-[16px] text-gray-600">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>Duration: {test?.totalDurationMinutes}</span>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span>
                  Questions:{" "}
                  {test?.totalTests || test?.totalQuestions || 0}{" "}
                </span>
              </div>
            </div>
            {/* Language */}
  ...
  const filteredTests = useMemo(() => {
    return tests.filter((test) => {
      ...
      const matchesDifficulty =
        !filters.difficulty || test.difficultyLabel === filters.difficulty;
                          ...
                          {activeFilterTab === "difficulty" && (
                            <>
                              {[
                                ...
                                <label
                                  key={opt.value}
                                  className="flex items-center justify-between text-sm cursor-pointer hover:bg-gray-50 p-2 rounded-lg"
                                >
                                  {opt.label}
                                  <input
                                    type="radio"
