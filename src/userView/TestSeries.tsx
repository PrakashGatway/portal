      ...
      <div className="relative rounded-2xl h-full bg-white p-2 overflow-hidden">
        ...
        <div className="flex items-start mt-auto">
          ...
          <button
            ...
            onClick={() => {
              series?.pricing?.isFree || series?.isPurchased === true
...
export default function TestSeriesPage() {
  ...
  const [activeFilterTab, setActiveFilterTab] = useState<"type" | "mode">(
    "type",
  );
              ...
              <div className="flex h-full flex-col rounded-3xl bg-white p-5 dark:bg-gray-800">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <h3 className="mt-px text-lg font-bold leading-tight text-[#F36D45]">
                      Raise a Ticket
                    </h3>
                  </div>
                </div>
                ...
                {/* Description */}
                <p className="mt-3 text-sm leading-6 text-gray-600 font-medium dark:text-gray-400">
                  Get help with account, payment, course or class issues
                </p>

                {/* Ticket Info */}
                <div className="mt-1 flex items-center gap-2 rounded-xl bg-gray-50 px-3 py-2.5 dark:bg-gray-900/60">
                          ...
                          <div className="w-1/3 border-r bg-gray-50">
                            {["type", "mode"].map((tab) => (
                              <button
                                ...
                                className={`w-full px-4 py-3 text-left text-sm font-medium border-l-4 ${
                                  activeFilterTab === tab
