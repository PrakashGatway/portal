...
.rbc-row-content .rbc-date-cell a {
  pointer-events: auto;
            ...
            .rbc-row { overflow: hidden !important; }
            .rbc-row-segment { padding: 2px 4px; overflow: hidden !important; position: relative; }
            .rbc-event { overflow: hidden !important; }
            .rbc-event-content { overflow: hidden !important; }
            .rbc-month-view .rbc-event { z-index: 100 !important; }
            ...
            .rbc-time-header .rbc-row:last-child { display: none !important; }
            .rbc-time-header .rbc-row:first-child { display: flex; align-items: center; height: 100%; }
            
            .rbc-time-view .rbc-event { overflow: hidden !important; white-space: normal !important; min-width: 0 !important; }
            .rbc-time-view .rbc-event-content { overflow: hidden !important; min-width: 0 !important; width: 100% !important; }
            ...
            .rbc-time-header-content .rbc-header > span {
              ...
              width: 100%; max-width: 100px; height: 36px;
              border-radius: 18px; background: #FED7AA; color: #1F2937;
            ...
            .rbc-label { color: #9CA3AF; font-size: 0.75rem; font-weight: 500; padding: 0 8px; }
            .rbc-time-slot { border: none !important; background: #FFF7ED !important; }
            ...
            .rbc-event { border: none !important; border-radius: 6px; padding: 2px 6px; font-size: 0.75rem; font-weight: 600; }
