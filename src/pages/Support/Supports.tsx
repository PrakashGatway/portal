...
const SupportPage = () => {
  ...
  // Fetch support categories from JSON API
  useEffect(() => {
  ...
  const quickActions = [
    {
      ...
      action: "Online Now",
      icon: MessageCircle,
      actionClass: "bg-green-100/50 text-green-600",
      onClick: undefined,
    },
    {
      title: "Email Support",
      description: "We reply in 24 hrs",
      action: "Send Email",
      icon: Mail,
      actionClass: "bg-orange-50 text-orange-500",
      onClick: () => {
        window.location.href = "mailto:support@ooshasprep.com";
      },
    },
    {
      title: "Call Support",
  ...
  return (
    <div className="min-h-screen dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-0">
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <p className="mt-2 text-sm sm:text-base text-[#6B7280]">
                    We're here to help you succeed. Find answers or get in touch
                    with our team.
                  </p>
                </div>
                ...
                <div>
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                    ...
                    <Link
                      to="/all-tickets"
                      type="button"
                      className="flex h-[38px] w-full sm:w-auto items-center justify-center rounded-[8px] border border-[#E5E3E1] bg-white px-5 text-[12px] font-semibold text-[#444444] transition-all duration-300 hover:border-[#F45B2A] hover:bg-[#FFF7F3] hover:text-[#F45B2A]"
                    >
                      All Support Tickets
                    </Link>
                    ...
                    <button
                      type="button"
                      className="group flex h-[38px] w-full sm:w-auto items-center justify-center gap-2 rounded-[8px] bg-[#F45B2A] px-5 text-[12px] font-semibold text-white shadow-[0_4px_10px_rgba(244,91,42,0.16)] transition-all duration-300 hover:bg-[#E94F20] hover:shadow-[0_6px_16px_rgba(244,91,42,0.22)]"
                      onClick={() => setShowCreateForm(true)}
                    >
                      <Plus
                        size={17}
            ...
            <div className="flex justify-between item-center">
              ...
              <div className="h-full sm:mt-8 w-full lg:w-[700px] rounded-2xl border border-[#E8E8E8] bg-white p-3 sm:p-4 shadow-sm">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                  <div className="relative flex-1">
                    ...
                    <input
                      ...
                      className="w-full h-12 rounded-xl border border-[#E5E7EB] bg-white pl-11 pr-4 text-sm text-[#333] outline-none placeholder:text-[#9CA3AF] focus:border-[#FF6B35] focus:ring-1 focus:ring-[#FF6B35]"
                    />
                  </div>

                  <Link
                    to={`https://www.ooshasprep.com/guide?search=${search}`}
                    className="flex h-12 items-center justify-center rounded-xl bg-[#FF6B35] px-7 text-sm font-semibold text-white shadow-sm transition duration-200 hover:bg-[#F15A24]"
                  >
                    Search
                  </Link>
                </div>
                ...
                <div className="mt-3 flex flex-wrap items-center gap-2">
                  ...
                  {supportCategories?.slice(0, 7)?.map((item) => (
                    <Link
                      key={item.slug || item._id}
                      to={`https://www.ooshasprep.com/guide?category=${item?.slug}`}
                      className="rounded-full bg-[#FFF8F5] border border-[#F8EDE7] px-3 py-1.5 text-[11px] sm:text-xs text-[#666] whitespace-nowrap hover:bg-[#FFF0EA] hover:text-[#FF6B35] transition"
                    >
                      {item.name}
                    </Link>
                  ))}
              ...
              {/* Right Illustration */}
              <div className="hidden lg:block w-[310px] xl:w-[300px] pointer-events-none">
                <img
        ...
        <div className="font-semibold text-xl mt-4">How can we help you?</div>

        {/* Quick Action Cards - Fixed alignment */}
        <div className="my-6 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {quickActions.map((item) => {
            ...
            return (
              <div
                key={item.title}
                className="relative flex min-h-[120px] items-start gap-4 rounded-2xl bg-white p-4 shadow-lg transition-shadow hover:shadow-xl"
              >
                {/* Icon */}
                <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-orange-50">
                ...
                <div className="flex min-w-0 flex-1 flex-col gap-4">
                  ...
                  <button
                    ...
                    className={`w-fit absolute bottom-2  rounded-xl px-3 py-2 text-sm font-bold transition-opacity 
                      hover:opacity-80 ${item.actionClass}`}
                  >
                    {item.action}
                  </button>
                </div>
        ...
        {/* Browse Help Topics - Fixed alignment */}
          ...
          <div className="mx-auto w-full max-w-[1400px]">
            ...
            <div className="mb-4 flex items-center justify-between gap-4">
              ...
              <Link
                ...
                className="group flex shrink-0 items-center gap-1.5 text-[12px] font-medium text-[#E87545] 
                transition-colors hover:text-[#D95F32] sm:text-base"
              >
            ...
            {supportLoading ? (
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="min-h-[158px] animate-pulse rounded-[15px] border border-[#E9E7E5] bg-white p-4 sm:p-[17px]"
                  >
                    <div className="flex items-start gap-3">
                      <div className="h-[43px] w-[43px] shrink-0 rounded-full bg-gray-200" />
              ...
              <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-gray-300 bg-white py-12">
              ...
              <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {supportCategories.map((topic, index) => {
                  ...
                  return (
                    <Link
                      key={topic._id || topic.slug || index}
                    ...
                    >
                      <div className="group relative flex h-full min-h-[100px] flex-col rounded-[15px] border border-[#E9E7E5] bg-white p-4 shadow-[0_1px_3px_rgba(0,0,0,0.02)] transition-all duration-300 hover:-translate-y-0.5 hover:border-[#E4DCD7] hover:shadow-[0_8px_24px_rgba(0,0,0,0.06)] sm:p-[17px]">
                        ...
                        {/* Article count */}
                        {topic.articles !== undefined && (
                          <div className="mt-auto pl-[55px] pt-2">
        ...
        <section className="w-full px-4 py-6 sm:px-6 lg:px-0">
          ...
          <img src="/images/headphone.webp" alt="" className="w-20 h-20 scale-90" />
                ...
                {/* Text */}
                <div>
                  <h2 className="text-[17px] font-bold leading-6 tracking-[-0.2px] text-[#242424] sm:text-[18px]">
                    Can't find what you're looking for?
                  </h2>

                  <p className="mt-2 text-[12px] leading-5 text-[#777777] sm:text-[13px]">
              ...
              <button
                type="button"
                onClick={() => setShowCreateForm(true)}
                className="group relative z-10 flex h-[44px] w-full items-center justify-center gap-3 rounded-[10px] bg-[#F45B2A] px-6 text-[13px] font-semibold text-white shadow-[0_5px_14px_rgba(244,91,42,0.18)] transition-all duration-300 hover:bg-[#E94E20] hover:shadow-[0_7px_18px_rgba(244,91,42,0.25)] sm:w-auto sm:min-w-[222px]"
              >
            ...
            <div className="grid grid-cols-1 overflow-hidden rounded-[14px] border border-[#ECE9E7] bg-white sm:grid-cols-3">
              {supportBenefits.map((item, index) => {
                ...
                return (
                  <div
                    key={item.title}
                    className={`flex items-center gap-4 px-6 py-5 sm:px-7 lg:px-10 ${
                  ...
                  >
                    {/* Icon */}
                    <div className="flex h-[36px] w-[36px] shrink-0 items-center justify-center rounded-full bg-[#FFF1E9]">
                      <Icon
                        size={19}
                        strokeWidth={2.3}
                    ...
                    <div className="min-w-0">
                      <h3 className="text-base font-semibold leading-[18px] text-[#353535]">
                        {item.title}
                      </h3>

                      <p className="mt-0.5 text-sm leading-[17px] text-[#858585]">
                        {item.description}
                      </p>
                    </div>
                  </div>
...
//   {
//     title: "Email Support",
//     description: "We usually reply in 24 hrs",
//     action: "Send Email",
//     icon: Mail,
//     actionClass: "bg-orange-50 text-orange-500",
//     onClick: () => {
//       window.location.href =
//         "mailto:support@ooshasprep.com";
//     },
//   },
//   {
//     title: "Call Support",
...
//       <div
//         key={item.title}
//         className="flex min-h-[150px] items-start gap-4 rounded-2xl bg-white p-4 shadow-lg"
//       >
//         {/* Icon */}
//         <div className="flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-orange-50">
//           <Icon
...
//             type="button"
//             onClick={item.onClick}
//             className={`w-fit rounded-xl px-3 py-2 text-sm font-bold transition-opacity hover:opacity-80 ${item.actionClass}`}
//           >
//             {item.action}
//           </button>
//         </div>
