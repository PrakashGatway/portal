          ...
          <div className="bg-white shadow-lg flex gap-4 p-4 rounded-2xl justify-center items-center min-h-[150px]">
            ...
            <div className="flex flex-col gap-4 min-w-0">
              <div className="space-y-1 flex flex-col">
                ...
                <span className="text-sm text-gray-500">Submit your issue</span>
              </div>

              <div
                onClick={() => setShowCreateForm(true)}
                className="bg-orange-50 rounded-xl py-2 px-3 w-fit flex justify-center items-center font-bold text-sm text-orange-500 "
              >
                Create Ticket
              </div>
            </div>
