...
//         {/* Filters card */}
//         <div className="mb-4 rounded-2xl border border-gray-200 bg-white p-4  dark:border-gray-800 dark:bg-gray-900/60">
...
//                   className="w-full rounded-xl border border-gray-200 bg-white py-2 pl-9 pr-3 text-sm text-gray-900  focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100"
//                 />
//               </div>
//             </div>
//             {/* Exam filter */}
...
//                 className="group rounded-2xl border border-gray-200 bg-white p-4  transition hover:-translate-y-0.5 hover: dark:border-gray-800 dark:bg-gray-900"
//               >
...
//               {/* panel */}
//               <motion.div
//                 className="relative ml-auto flex h-full w-full max-w-4xl flex-col border-l border-gray-200 bg-white  dark:border-gray-800 dark:bg-gray-900"
//                 initial={{ x: "100%" }}
//                 animate={{ x: 0 }}
//                 exit={{ x: "100%" }}
...
//                           if (examName.includes("pte"))
//                             return t.label.startsWith("PTE")
//                           return true;
//                         })}
