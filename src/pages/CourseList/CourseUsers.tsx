...
const heroImages = [
  {
    ...
    description:
      "Master JEE with India's most trusted coaching platform. Live classes, doubt solving, personal mentors.",
  ...
  },
  {
    ...
    description:
      "Comprehensive NEET preparation with expert faculty, live doubt sessions, and extensive test series.",
  ...
  },
  {
    ...
    description:
      "Take your JEE preparation to the next level with advanced concepts and expert guidance.",
...
const ImageSlider = ({
  ...
  useEffect(() => {
    ...
    const images = filterBanner.Banners.filter(
      (item) => item?.Banner?.file,
    ).map((item) => ({
          ...
          <div className="flex justify-center items-center mt-12 space-x-2">
            <button
              ...
              style={{
                borderColor: COLORS.border,
                color:
                  filters.page === 1 ? COLORS.textLight : COLORS.textPrimary,
              }}
            >
              Previous
            </button>
