            ...
            <div className="bg-gradient-to-r from-orange-500 to-orange-600 dark:from-gray-800 dark:to-gray-900 border-b border-orange-100 dark:border-gray-700 p-3 pb-2">
                <div className="flex items-center justify-between">
                    <div className="flex items-center">
                        ...
                        <h2 className="text-base font-semibold text-white truncate">{classTitle || classId}</h2>
                    </div>
                ...
                <div className="flex mt-2 text-sm text-white/80">
                    {isMuted && (
                        <span className="flex items-center bg-amber-500/20 px-2 py-1 rounded">
                                    ...
                                    className={`p-2 px-3 rounded-2xl max-w-[85%] ${
                                        message.isSystem
                                            ...
                                            : message.username === username
                                                ? 'ml-auto bg-[#ffe2cc] text-gray-600 rounded-br-md'
                                                : message.isAdmin
                                                    ? 'mr-auto bg-[#FFF1D1] text-black rounded-bl-md'
                                        ...
                                        <div>
                                            <div className="flex items-baseline gap-1">
                                                <span className={`font-semibold text-xs ${
                                                    ...
                                                    <span className="text-xs bg-amber-400 text-amber-900 px-1.5 py-0 rounded-xl">ADMIN</span>}
                                                </span>
                        ...
                        <div className="flex gap-2">
                            ...
                            <motion.button
                                ...
                                className={`px-3 rounded-xl font-medium flex items-center ${
                                    newMessage.trim() && isConnected && !isMuted
