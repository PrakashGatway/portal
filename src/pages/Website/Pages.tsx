  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      ...
      keywords: Array.isArray(formData.keywords)
        ? formData.keywords
        : formData.keywords?.split(",").map((t) => t.trim()) || [],
          ...
          {loading ? (
            ...
            <table className="w-full divide-y divide-gray-200 dark:divide-gray-700">
              <thead className="bg-gray-50 dark:bg-gray-800">
                <tr>
                  <th className="px-4 py-3 text-left text-xs font-medium uppercase text-gray-500 dark:text-gray-300 sm:px-6">
                    Title
                  </th>
                  <th className="px-4 py-3 text-left text-xs font-medium uppercase text-gray-500 dark:text-gray-300 sm:px-6">
                    Type
                  </th>
                  <th className="hidden md:table-cell px-4 py-3 text-left text-xs font-medium uppercase text-gray-500 dark:text-gray-300 sm:px-6">
                    Slug
                  </th>
                  <th className="px-4 py-3 text-left text-xs font-medium uppercase text-gray-500 dark:text-gray-300 sm:px-6">
                    Status
                  ...
                  <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                    <div>
                      ...
                      <select
                        ...
                        onChange={async (e) => {
                          handleInputChange(e);
                          if (
                            e.target.value == "country_page" &&
                            !selectedPage
                          ) {
                            const resData = await api.get(
                              `/page/uk?type=country_page`,
                            );
                    ...
                    <div>
                      ...
                      <CKEditorComponent
                        ...
                        onChange={(content) =>
                          handleInputChange({
                            target: { name: "subTitle", value: content },
                          })
                        }
                        placeholder={`...`}
                      />
          ...
          <div className="no-scrollbar relative w-full overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-6">
            <div className="px-2 pr-14">
              ...
              <p className="mb-2 text-sm text-gray-500 dark:text-gray-400 lg:mb-2">
                Are you sure you want to delete this entity? This action cannot
                be undone.
              </p>
            </div>
            <div className="px-2">
                ...
                <div className="flex">
                  <div className="ml-3">
                    ...
                    <div className="mt-2 text-sm text-red-700 dark:text-red-300">
                      <p>
                        Deleting "{selectedPage.title}" will permanently remove
                        it from the system.
                      </p>
                    </div>
                  </div>
            ...
            <div className="flex items-center gap-3 px-2 mt-6 lg:justify-end">
              ...
              <Button size="sm" variant="primary" onClick={deleteEntity}>
                Delete Entity
              </Button>
            </div>
          </div>
