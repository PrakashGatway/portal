...
const CounselorUser = () => {
  ...
  return (
    <div className="w-full overflow-x-auto">
        ...
        <div className="mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <div className="flex justify-between w-full items-center ">
            ...
            <button
              ...
              className="inline-flex items-center rounded-lg border border-green-300 bg-white hover:bg-green-300 px-4 py-3 text-sm font-medium hover:text-black text-green-700 shadow-sm hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700 transition-colors"
            >
      ...
      {/* Edit User Modal */}
      <Modal isOpen={ModalOpen} onClose={() => setModalOpen(false)} className="max-w-[700px] m-4">
        <div className="no-scrollbar relative w-full max-w-[700px] overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
          <div className="px-2 pr-14">
            <h4 className="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">Add User</h4>
            <p className="mb-6 text-sm text-gray-500 dark:text-gray-400 lg:mb-7">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  {/* <div>
                    ...
                    >
                      ...
                      {Assignto.map((role) => (
                        <option key={role} value={role?._id} className="capitalize">
                          {role.name}
                        </option>
                      ))}
                    </select>
