      ...
      {inputType === "youtube" ? (
        <div>
          ...
          <Input
            ...
            onChange={(e) =>
              onChange({ url: e.target.value, publicId: "youtube" })
            } // Include type and clear others
        ...
        <div>
          ...
          <div className="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4">
            ...
            >
              ...
              {value?.url && value?.publicId === "upload"
                ? "Change Video"
                : "Select Video File"}{" "}
      ...
      setFormData({
        ...
        schedule: {
          ...
          endDate: course.schedule?.endDate
            ...
            : "",
          enrollmentDeadline: course.schedule?.enrollmentDeadline
            ? new Date(course.schedule.enrollmentDeadline)
                .toISOString()
                .slice(0, 16)
            : "",
        ...
        pricing: {
          ...
          earlyBird: {
            ...
            deadline: course.pricing?.earlyBird?.deadline
  ...
  useEffect(() => {
    if (formData.category) {
      ...
      if (
        ...
        !filteredSubcategories.some((sub) => sub._id === formData.subcategory)
      ) {
    ...
    switch (step) {
      ...
      case 2:
        if (!formData.schedule.startDate)
          newErrors["schedule.startDate"] = "Start date is required";
        if (!formData.schedule.endDate)
          newErrors["schedule.endDate"] = "End date is required";
        if (
      ...
      const payload = {
        ...
        schedule: {
          ...
          endDate: formData.schedule.endDate
            ...
            : null,
          enrollmentDeadline: formData.schedule.enrollmentDeadline
            ? new Date(formData.schedule.enrollmentDeadline).toISOString()
            : null,
        },
        pricing: {
          ...formData.pricing,
          earlyBird: {
            ...
            deadline: formData.pricing.earlyBird.deadline
              ? new Date(formData.pricing.earlyBird.deadline).toISOString()
              : null,
          },
        },
      };
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <div className="md:col-span-2">
          ...
          <MultiSelect
            ...
            onChange={(selected) =>
              handleMultiSelectChange("instructors", selected)
            }
          />
        </div>
        <div>
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <Select
          ...
          onChange={(value) =>
            handleNestedChange("schedule_pattern.frequency", value)
          }
        />
      </div>
      <div>
